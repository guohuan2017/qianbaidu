...
<body>
	<img src="/qianbaidu/img/zhifu/cashdesk/收银台logo_看图王.jpg"
		style="position: absolute;">
	<header id="header">
	<i class="eleme-icon logo"><h1 class="title"></h1></i></header>
	<main id="main"> <main data-reactid=".0"> <section
		class="container order" data-reactid=".0.0">
	...
	<div class="order-detail clearfix" data-reactid=".0.0.1">
		<div class="pull-left" data-reactid=".0.0.1.0">
			...
			${user.username} 先生 手机：${user.phone} 地址：${address.address}<br>
			<%-- <c:forEach var="food" items="${foodlist}">
								${food.foodname} x  ${food.number}<br>
								</c:forEach> --%>
			</span> <a class="text-primary show-detail text-link"
				data-reactid=".0.0.1.0.1.1"><span data-reactid=".0.0.1.0.1.1.0">查看详情</span><span
		...
		<p class="pull-right" data-reactid=".0.0.1.1">
			<span data-reactid=".0.0.1.1.0"><span
				...
				class="text-lg text-highlight" data-reactid=".0.0.1.1.0.1"><span
					...
					data-reactid=".0.0.1.1.0.1.1">${orderList.total_price}</span></strong></span>
		</p>
	</div>
	</section> <section class="container paymethods" data-reactid=".0.1"> <header
		data-reactid=".0.1.0">
	<h3 data-reactid=".0.1.0.0">请选择支付方式</h3>
	<p class="text-muted" data-reactid=".0.1.0.1">
		<span data-reactid=".0.1.0.1.0">请尽快支付</span><span
			class="text-highlight" data-reactid=".0.1.0.1.1"></span><span
			data-reactid=".0.1.0.1.2">，逾期订单将自动取消</span>
	</p>
	</header> <section class="native-payment-list clearfix hidden"
		data-reactid=".0.1.1">
	...
	</section> <section class="third-payment" data-reactid=".0.1.2">
	...
	</section> <footer class="paypassword" data-reactid=".0.1.3">
	<form class="hide" name="password" data-reactid=".0.1.3.1">
		...
		<input placeholder="请输入6位支付密码" class="" type="password" value=""
			data-reactid=".0.1.3.1.1.0">
		<span class="text-muted" data-reactid=".0.1.3.1.1.1">如您忘记密码,
			请前往商家版手机端修改</span> <a class="text-primary text-link"
			data-reactid=".0.1.3.1.1.2">忘记密码?</a> </section>
	...
	</section> <section class="modal-backdrop" style="display:none;"
	...
	<div class="modal" data-reactid=".0.1.3.3.0">
		...
		<span class="icon-close pull-right text-muted"
			data-reactid=".0.1.3.3.0.0.0.0">x</span></header>
	...
	<button type="button" id="queren" class="btn btn-success btn-lg"
	...
	</script> </section> <section class="messagebox-backdrop" style="display:none;"
		data-reactid=".0.2">
